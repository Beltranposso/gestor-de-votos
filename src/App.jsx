    ...
    <div className='content'>
      <header className='cabezera'>
        <div className='div_header'>
          ...
          {/*    <img src={logoControl360 }  width={400} height={100}/> */}
          <h1>LOGO</h1>
        </div>
        ...
        <aside className='aside' style={State ? { left: '-300px' } : { left: '0px' }}>
          <div className='content_aside'>
            <ul className='lista'>
              ...
              <li><Link className='link_Aside' to="/listUsers"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-user">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                <path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
